...
# droptrain = train.drop(['Survived'], axis=1)
# print(droptrain.head())
#
# print(clf.classes_)
#
# dot_data = StringIO()
# tree.export_graphviz(clf, out_file=dot_data, feature_names=droptrain.keys(), class_names=str(clf.classes_),
