...
class Application():
    ...
    def createFrameTop(self):
        ...
        for (i, operate) in enumerate(show_list):
            label_top = tk.Label(self.frm_top, width = 15, height=2, bg=root_bg, text=show_list[i], font=('Tempus Sans ITC', 10))
    ...
    def createFrameMiddleLeft(self):
        ...
        '''
        self.frm_middle_left = tk.LabelFrame(self.frm_middle, bg=root_bg, font=('Tempus Sans ITC', 10))
        self.frm_middle_left.grid(row = 0, column = 0, padx = 5, pady = 2,sticky = "wesn")

        self.btn_middle_list = []
        for i in range(SIDE*SIDE):
            entry_bottom = tk.Button(self.frm_middle_left, width = 6, height=3, borderwidth=1, font=('Tempus Sans ITC', 10, "bold"))
    ...
    def createFrameMiddleRight(self):
        ...
        for (i, operate) in enumerate(operate_list):
            label_middle_right = tk.Label(self.frm_middle_right, width=30, height=1, bg=root_bg, text=operate, font=('Tempus Sans ITC', 10))
    ...
    def createFrameBottom(self):
        ...
        for (i, operate) in enumerate(show_list):
            label_bottom = tk.Label(self.frm_bottom, width = (i+1)*12, height=2, bg=root_bg, text=show_list[i], font=('Tempus Sans ITC', 8))
    ...
    def btn_show_matrix(self, matrix):
        ...
        btn_color_dict = {
                          0 : ['ghost white', 'black'], 
                          2 : ['bisque', 'deep sky blue'], 
                          4 : ['navajo white', 'deep sky blue'], 
                          8 : ['peach puff', 'deep sky blue'],
                          16 : ['spring green', 'purple1'], 
                          32 : ['lawn green', 'purple1'], 
                          64 : ['medium spring green', 'purple1'],
                          128 : ['tomato', 'ghost white'], 
                          256 : ['orange red', 'ghost white'], 
                          512 : ['light coral', 'ghost white'],
                          1024 : ['lightgreen', 'orange red'], 
                          2048 : ['maroon1', 'lightgreen']
                         }
