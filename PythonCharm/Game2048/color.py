...
class Application():
    ...
    def createFrameTop(self):
        ...
        self.label_top_list = []
        for (i, operate) in enumerate(COLORS):
            label_top = tk.Label(self.frm_top, width = 5, height=1, text='', bg=COLORS[i], font=('Tempus Sans ITC', 10))
            label_top.grid(row = i//18, column = i%18, padx = 5, pady = 1, sticky = "wesn")
